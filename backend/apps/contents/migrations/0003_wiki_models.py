    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        related_name="wiki_tag_definitions",
                        to="novels.branch",
                    ),
                ),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "first_appearance",
                    models.IntegerField(blank=True, null=True, verbose_name="첫 등장 회차"),
                ),
                ("hidden_note", models.TextField(blank=True, verbose_name="작가 노트 (비공개)")),
                (
                    "ai_metadata",
                    models.JSONField(blank=True, null=True, verbose_name="AI 메타데이터"),
                ),
                (
                    "branch",
                    models.ForeignKey(
