    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "fork_point_chapter",
                    models.IntegerField(blank=True, null=True, verbose_name="분기 회차"),
                ),
                ...
                (
                    "visibility",
                    models.CharField(
                        choices=[("PRIVATE", "비공개"), ("PUBLIC", "공개"), ("LINKED", "연결됨")],
                        default="PRIVATE",
                        max_length=20,
                        verbose_name="공개 상태",
                    ),
                ...
                (
                    "merged_at_chapter",
                    models.IntegerField(blank=True, null=True, verbose_name="편입 회차"),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "reviewed_at",
                    models.DateTimeField(blank=True, null=True, verbose_name="리뷰 일시"),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "age_rating",
                    models.CharField(
                        choices=[("ALL", "전체"), ("12", "12세"), ("15", "15세"), ("19", "19세")],
                        default="ALL",
                        max_length=10,
                        verbose_name="연령등급",
                    ),
                ...
                (
                    "status",
                    models.CharField(
                        choices=[("ONGOING", "연재중"), ("COMPLETED", "완결"), ("HIATUS", "휴재")],
                        default="ONGOING",
                        max_length=20,
                        verbose_name="상태",
                    ),
