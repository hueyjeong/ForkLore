    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('READER', 'Reader'), ('AUTHOR', 'Author'), ('ADMIN', 'Admin')], default='READER', max_length=20, verbose_name='역할')),
                ('auth_provider', models.CharField(choices=[('LOCAL', 'Local'), ('GOOGLE', 'Google'), ('KAKAO', 'Kakao')], default='LOCAL', max_length=20, verbose_name='인증 제공자')),
                ('provider_id', models.CharField(blank=True, max_length=255, verbose_name='제공자 ID')),
