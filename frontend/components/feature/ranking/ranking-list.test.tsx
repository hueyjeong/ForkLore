...
const mockNovels: RankingNovel[] = [
  { id: 1, title: '1위 소설', author: '작가1', views: '1.2M', rating: 4.9, cover: 'https://example.com/1.jpg', status: '연재중', tags: ['판타지'] },
  { id: 2, title: '2위 소설', author: '작가2', views: '980K', rating: 4.8, cover: 'https://example.com/2.jpg', status: '완결', tags: ['로맨스'] },
  { id: 3, title: '3위 소설', author: '작가3', views: '850K', rating: 4.7, cover: 'https://example.com/3.jpg', status: '연재중', tags: ['액션'] },
  { id: 4, title: '4위 소설', author: '작가4', views: '720K', rating: 4.6, cover: 'https://example.com/4.jpg', status: '완결', tags: ['미스터리'] },
  { id: 5, title: '5위 소설', author: '작가5', views: '650K', rating: 4.5, cover: 'https://example.com/5.jpg', status: '연재중', tags: ['SF'] },
];
